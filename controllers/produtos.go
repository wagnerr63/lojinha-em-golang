...
var temp = template.Must(template.ParseGlob("templates/*.html")) //Carrega todos os templates html
...
func Insert(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		models.AdicionaProduto(nome, descricao, precoConvertido, quantidadeConvertida)
